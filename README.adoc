...
:experimental:
:url-github: https://github.com/hyperpolymath/thejeffparadox
:url-gitlab: https://gitlab.com/hyperpolymath/thejeffparadox
:url-bitbucket: https://bitbucket.org/hyperpolymath/thejeffparadox
:url-codeberg: https://codeberg.org/hyperpolymath/thejeffparadox

The Jeff Paradox - decision theory exploration
...
thejeffparadox is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
